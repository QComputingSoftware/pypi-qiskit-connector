...
def iCal_Weekly():
    """
    Calculates the average weekly app downloads using Unix epoch timestamps.
    """
...
calculated_weekly_downloads = iCal_Weekly()
try:
    if td is not None:
        mdata = round(calculated_weekly_downloads)
        print(f"✅ Weekly downloads successfully retrieved!")
